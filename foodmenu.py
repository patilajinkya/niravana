...
menu = {
    ...
    "Main Course (Veg)": [
        ("Dal Fry", 170), ("Dal Tadka", 190), ("Dal Makkani", 220), ("Rajma", 200), ("Dum Aloo", 180),
        ("Aloo Mattar", 190), ("Aloo Gobhi", 190), ("Aloo Jeera", 180), ("Mixed veg", 220),
        ("Kadai Paneer", 290), ("Mattar Paneer", 290), ("Panner Butter Masala", 300), ("Kaju Paneer", 340)
    ],
    "Main Course (Non Veg)": [
        ("Kadai Chicken", 460), ("Chicken Curry", 460), ("Rara Chicken", 480), ("Butter Chicken", 520),
        ("Mughlai Chicken", 540), ("Kaju Chicken", 550), ("Egg Curry", 200), ("Egg Burji", 180)
    ],
    "Roti": [
    ...
    "South Indian": [
        ...
        ("Ponganalu (6 Pcs)", 120), ("Upma Suji", 120), ("Upma Broken Rice", 130), ("Vermecelli Upma", 150),
        ("Lemon Rice", 200), ("Tamarind Rice (Pulihora)", 190), ("Mango Dal", 210), ("Curd Rice", 180),
        ("Sambar Rice", 260), ("Rasam Rice", 210), ("Dal rasam Rice", 220), ("Aloo Fry", 200),
        ("Punugulu Curry", 250), ("Guttu Vankay", 240), ("Kaju Chicken Pakodi", 450), ("Andhra Chicken Fry", 460)
    ],
    "Biryanis": [
        ("Bagara Rice & Chicken Curry", 500), ("Bagara Rice & Chicken Fry", 500),
        ("Bagara Rice & Aloo Fry", 400), ("Chicken Dum Biryani", 550), ("Mutton Dum Biryani", 650),
        ("Andhra Chicken Biryani", 490)
    ],
    "Dessert": [
